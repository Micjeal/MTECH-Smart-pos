"use strict";
const VERSION = "mtech-pos-v4.3.0-r2";
const APP_SHELL = [
  "/",
  "/index.html",
  "/offline.html",
  "/manifest.webmanifest",
  "/assets/css/app.css?v=4.3.0-r2",
  "/assets/vendor/zxing/zxing-browser.min.js?v=4.3.0-r2",
  "/assets/js/icons.js?v=4.3.0-r2",
  "/assets/js/db.js?v=4.3.0-r2",
  "/assets/js/app.js?v=4.3.0-r2",
