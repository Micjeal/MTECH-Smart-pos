"use strict";
const VERSION = "mtech-pos-v4.5.0-r1";
const APP_SHELL = [
  "/",
  "/index.html",
  "/offline.html",
  "/manifest.webmanifest",
  "/assets/css/app.css?v=4.5.0-r1",
  "/assets/vendor/zxing/zxing-browser.min.js?v=4.5.0-r1",
  "/assets/js/icons.js?v=4.5.0-r1",
  "/assets/js/db.js?v=4.5.0-r1",
  "/assets/js/app.js?v=4.5.0-r1",
